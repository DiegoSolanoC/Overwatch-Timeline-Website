/**
 * HackedOverlayManager - Manages hacked overlay positioning and animation over glitchy text
 */

export class HackedOverlayManager {
    constructor() {
        // No state needed - method is stateless
    }
