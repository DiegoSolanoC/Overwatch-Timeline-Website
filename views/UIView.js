...
export class UIView {
    ...
    setupEventPagination(onPageChange) {
        ...
        // Store the parent and next sibling for proper insertion
        const prevBtnParent = prevBtn.parentNode;
        const prevBtnNextSibling = prevBtn.nextSibling;
        ...
        const nextBtnNextSibling = nextBtn.nextSibling;
        const nextBtnClone = nextBtn.cloneNode(true);
        nextBtnParent.replaceChild(nextBtnClone, nextBtn);
        
        const pageInputParent = pageInput.parentNode;
        const pageInputNextSibling = pageInput.nextSibling;
        const pageInputClone = pageInput.cloneNode(true);
        pageInputParent.replaceChild(pageInputClone, pageInput);
